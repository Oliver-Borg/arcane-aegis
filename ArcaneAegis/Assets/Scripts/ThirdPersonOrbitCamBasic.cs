...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	public float horizontalAimingSpeed = 30f;                           // Horizontal turn speed.
	public float verticalAimingSpeed = 30f;                             // Vertical turn speed.
	...
	void Update()
	{
		...
		angleH += xDelta * horizontalAimingSpeed * Time.deltaTime;
		angleV += yDelta * verticalAimingSpeed * Time.deltaTime;
